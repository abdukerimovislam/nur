...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void didChangeDependencies() {
    ...
    final initialIndex = _supportedLanguages
        .indexWhere((lang) => lang['code'] == provider.locale.languageCode);
    if (initialIndex != -1) {
          ...
          children: [
            Expanded(
              child: PageView.builder(
                ...
                physics:
                    const NeverScrollableScrollPhysics(), // Отключаем ручной свайп для контроля
                ...
                itemBuilder: (context, index) {
                  ...
                  if (index == 1) {
                    return _buildStandardSlide(
                      ...
                      title: 'Build your prayer habit',
                      desc:
                          'Track salah, keep your streak, and stay close to daily reminders.',
                    );
                  }
                  if (index == 2) {
                    return _buildStandardSlide(
                      ...
                      desc:
                          'Allow location access so Nur can calculate accurate prayer times for your city.',
                    );
                  }
  ...
  Widget _buildLanguageSlide(
      BuildContext context, AppLocalizations l10n, PrayerProvider provider) {
    return Padding(
            ...
            child: Stack(
              ...
              children: [
                ...
                ListWheelScrollView.useDelegate(
                  ...
                  perspective:
                      0.005, // Эффект 3D перспективы (чем больше цифра, тем сильнее цилиндр)
                  diameterRatio: 1.5, // Радиус цилиндра
                  physics:
                      const FixedExtentScrollPhysics(), // Останавливается ровно на элементе
                  onSelectedItemChanged: (index) {
                    // Меняем язык на лету при прокрутке
                    provider
                        .changeLanguage(_supportedLanguages[index]['code']!);
                  },
